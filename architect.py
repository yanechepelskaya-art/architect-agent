    ...
    try:
        ...
        for upd in r.get("result", []):
            ...
            if t in ["/status", "📊 Статус"]:
                ...
                kb = {"keyboard": [["👋 Привет", "📊 Статус"], ["😱 Страх", "💀 Ликв"], ["⛓ Ончейн", "📖 Стакан"], ["📰 Новости", "🧭 Компас"], ["⚓ Якорь", "📐 Чертёж"], ["🧠 Сенсор", "🔄 Разворот"], ["💡 Совет", "⚡ Энергия"], ["👁 Тень", "🌬 Дыхание"], ["💓 Пульс", "🗺 Уровни"], ["🪞 Зеркало", "🏮 Маяк"], ["🔮 Прогноз", "📝 Paper"], ["📈 Backtest", "📊 Экспорт"], ["📋 Бэктест", "🤖 ML-Прогноз"], ["⚙ Оптимизация"], ["🛑 Дневной лимит", "🔍 Анализ ошибок"], ["📋 История", "🏆 Топ"], ["📊 Статистика", "📊 Дэшборд"], ["🔗 Ссылка", "📈 График"], ["⏱ Аптайм", "🔍 Сканер"], ["🎯 Удар", "📝 Заметка"], ["⭐ A+ Сигнал", "🕐 Мульти-ТФ"], ["📊 Метрики"], ["📋 Заметки", "⚠️ Профиль"], ["🎭 Сентимент"]], "resize_keyboard": True}
